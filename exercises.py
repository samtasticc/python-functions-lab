...
# print('Exercise 1:', calculate_area_triangle(10, 5), calculate_area_triangle(7, 3))
...
# print('Exercise 2:', simple_interest(1000, 5, 2), simple_interest(1500, 3.5, 5))
...
# print('Exercise 3:', apply_discount(100, 25), apply_discount(80, 10))
...
# def convert_temperature(num, degree):
#     if degree == 'C':
#         return (num * 9/5) + 32
#     else:
#         return (num - 32) * 5/9
...
# print('Exercise 5:', sum_to(6), sum_to(10))
...
# print('Exercise 6:', largest(1, 2, 3), largest(10, 4, 2))
...
# print('Exercise 8:', product(-1, 4), product(2, 5, 5))
...
print('Exercise 9 Result:', basic_calculator(10, 5, "subtract"), basic_calculator(10, 5, "add"), basic_calculator(10, 5, "multiply"), basic_calculator(10, 5, "divide"))